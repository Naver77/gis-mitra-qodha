...
const Footer: React.FC<FooterProps> = ({ onFloatingWaClick }) => {
  ...
  return (
    <>
      <footer className="bg-gray-900 text-white pt-16 border-t border-gray-800 mt-auto z-40 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          {/* HAPUS lg:divide-x agar kita bisa kontrol garis pembatas secara manual dan presisi */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-6 lg:gap-y-0 mb-12">
            
            {/* KOLOM 1: Brand & Sertifikasi */}
            <div className="md:pr-8 md:border-r border-gray-800">
              <img 
            ...
            {/* KOLOM 2: Jelajahi */}
            <div className="pt-5 border-t border-gray-800 md:pt-0 md:border-t-0 md:pl-8 lg:px-8 lg:border-r lg:border-gray-800">
              <button onClick={() => toggleSection('jelajahi')} className="w-full flex justify-between items-center md:cursor-default focus:outline-none group">
                ...
                {/* BUNGKUS IKON DENGAN SPAN md:hidden AGAR BENAR-BENAR HILANG DI DESKTOP */}
                <span className="md:hidden flex items-center justify-center">
                  <i className={`fa-solid fa-chevron-down text-xs text-gray-500 transition-transform duration-300 ${openSection === 'jelajahi' ? 'rotate-180 text-brand-orange' : ''}`}></i>
                </span>
              </button>
              
              <div className={`overflow-hidden transition-all duration-300 md:max-h-none md:opacity-100 ${openSection === 'jelajahi' ? 'max-h-96 opacity-100 mt-4' : 'max-h-0 opacity-0 md:mt-6'}`}>
            ...
            <div className="flex flex-col pt-5 border-t border-gray-800 md:pt-8 md:mt-8 lg:pt-0 lg:mt-0 lg:border-t-0 md:pr-8 md:border-r lg:px-8 lg:border-gray-800">
              ...
              <div>
                <button onClick={() => toggleSection('store')} className="w-full flex justify-between items-center md:cursor-default focus:outline-none group">
                  ...
                  <span className="md:hidden flex items-center justify-center">
                    <i className={`fa-solid fa-chevron-down text-xs text-gray-500 transition-transform duration-300 ${openSection === 'store' ? 'rotate-180 text-brand-orange' : ''}`}></i>
                  </span>
                </button>
                <div className={`overflow-hidden transition-all duration-300 md:max-h-none md:opacity-100 ${openSection === 'store' ? 'max-h-40 opacity-100 mt-4' : 'max-h-0 opacity-0 md:mt-6'}`}>
                  <div className="flex flex-wrap gap-3">
              ...
              {/* Garis Horizontal Pemisah (Sesuai Permintaan: antara Official Store & Ikuti Kami) */}
              <div className="border-t border-gray-800 pt-5 mt-5 md:mt-8">
                <button onClick={() => toggleSection('sosmed')} className="w-full flex justify-between items-center md:cursor-default focus:outline-none group">
                  ...
                  <span className="md:hidden flex items-center justify-center">
                    <i className={`fa-solid fa-chevron-down text-xs text-gray-500 transition-transform duration-300 ${openSection === 'sosmed' ? 'rotate-180 text-brand-orange' : ''}`}></i>
                  </span>
                </button>
                <div className={`overflow-hidden transition-all duration-300 md:max-h-none md:opacity-100 ${openSection === 'sosmed' ? 'max-h-40 opacity-100 mt-4' : 'max-h-0 opacity-0 md:mt-6'}`}>
            ...
            <div className="pt-5 border-t border-gray-800 md:pt-8 md:mt-8 lg:pt-0 lg:mt-0 lg:border-t-0 md:pl-8">
              <button onClick={() => toggleSection('kontak')} className="w-full flex justify-between items-center md:cursor-default focus:outline-none group">
                ...
                <span className="md:hidden flex items-center justify-center">
                  <i className={`fa-solid fa-chevron-down text-xs text-gray-500 transition-transform duration-300 ${openSection === 'kontak' ? 'rotate-180 text-brand-orange' : ''}`}></i>
                </span>
              </button>
              
              <div className={`overflow-hidden transition-all duration-300 md:max-h-none md:opacity-100 ${openSection === 'kontak' ? 'max-h-125 opacity-100 mt-4' : 'max-h-0 opacity-0 md:mt-6'}`}>
          ...
          {/* COPYRIGHT BAR (Spasi Atas dan Bawah Presisi Rata Tengah) */}
          <div className="py-6 md:py-8 border-t border-gray-800 text-center flex items-center justify-center">
